...
#
# Script generated by Vivado on Fri Sep 27 12:07:30 +0000 2024
...
# script info
echo -e "mult_gen_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot mult_gen_1 xil_defaultlib.mult_gen_1 -log elaborate.log
}
