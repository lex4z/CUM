...
HD_PWD='/home/user/lab8/lab82/lab82.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab82.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab82.tcl -notrace
